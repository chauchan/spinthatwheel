...
static func get_starter_attack() -> Array[CardData]:
	...
	cards.append(_make("Accountant", CardData.CardType.ATTACK, 2, 2, 4, "Tank"))
	cards.append(_make("Salesman", CardData.CardType.ATTACK, 3, 4, 3, "Glass Cannon"))
	cards.append(_make("HR", CardData.CardType.ATTACK, 2, 1, 3, "Gets energy back when this card dies"))
	cards.append(_make("Shift Manager", CardData.CardType.ATTACK, 4, 6, 5, "BigBoi"))
	return cards
...
static func get_starter_energy() -> Array[CardData]:
	var cards: Array[CardData] = []
	cards.append(_make("9 to 5", CardData.CardType.ENERGY, 0, 0, 0, "+2 energy"))
	cards.append(_make("Productivity Bonus", CardData.CardType.ENERGY, 1, 0, 0, "+1 energy, draw from attack deck"))
	cards.append(_make("Loan", CardData.CardType.ENERGY, 0, 0, 0, "+3 energy, -1 energy next 2 turns"))
	cards.append(_make("Investing", CardData.CardType.ENERGY, 0, 0, 0, "+1 energy this turn, +2 energy after 2 turns"))
	cards.append(_make("Savings Account", CardData.CardType.ENERGY, 0, 0, 0, "Gain energy for each card you have in your hand"))
	return cards
